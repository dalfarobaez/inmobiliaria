const propiedades_venta = [
    ...
    src: 'https://www.diariodevaldivia.cl/files/60e5fe9f3bb9c_890x533.jpg',
    descripcion: 'Perfecta casa para estar en contacto con fauna de la zona. Aves y ardillas desde un ángulo privilegiado',
    ubicacion: 'Camino al volcán, Parcela 58, árbol 17, Cajón del Maipo',
    habitaciones: 4,
    banos: 3,
    costo: 6000,
    smoke: true,
...
try {
    propVenta = document.querySelector('#propiedadesVenta')
    propVenta.innerHTML = text_propiedad
} catch {console.log('html grande no insertado')}
try {
    indexVenta = document.querySelector('#indexVenta')
